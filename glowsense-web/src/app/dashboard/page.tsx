...
export default function DashboardPage() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (role !== "provider") {
        // Show customer dashboard or redirect
        setLoading(false);
        return;
      }
        ...
        <div className="bg-white rounded-2xl border border-border p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">{dashboardData.stats.total_services}</p>
            </div>
          ...
          <div className="bg-white rounded-2xl border-2 border-yellow-500 p-6 shadow-sm hover:bg-yellow-50/50 transition-colors cursor-pointer">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-700">{dashboardData.stats.pending_bookings}</p>
                {dashboardData.stats.pending_bookings > 0 && (
        ...
        <div className="bg-white rounded-2xl border border-border p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">{dashboardData.stats.portfolio_items_count}</p>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-border p-6 shadow-sm">
            {dashboardData.services.length === 0 ? (
              ...
              <div className="space-y-3">
                ...
                {dashboardData.services.length > 5 && (
                  <Link href="/dashboard/portfolio">
